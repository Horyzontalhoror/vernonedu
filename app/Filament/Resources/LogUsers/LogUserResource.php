...
class LogUserResource extends Resource
{
    ...
    protected static ?string $pluralLabel = 'Validasi Peserta';
    protected static ?string $label = 'Validasi Peserta';
    ...
    public static function getPages(): array
    {
        return [
            ...
            'create' => CreateLogUser::route('/create'),
            'edit' => EditLogUser::route('/{record}/edit'),
        ];
    }
}
